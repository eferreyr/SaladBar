...
using SaladBarWeb.Models.AccountViewModels;
...
namespace SaladBarWeb.Controllers
{
  ...
  public class AccountController : Controller
  {
      ...
      if (ModelState.IsValid)
      {
        ...
        if (user != null)
        {
          ...
          if (result.Succeeded)
          {
            ...
            //{
            //  claims.Append<Claim>(new Claim(ClaimTypes.Role, role));
            //}
          ...
          {
            return BadRequest(new { errorMessage = "Wrong username or password", errorCode = 404 });
          }
        }
        else
        {
    ...
    private async Task<bool> AddToResearchTeamMember(RegisterViewModel model)
    {
